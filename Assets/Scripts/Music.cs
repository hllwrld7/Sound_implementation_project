...
{
    public FMODUnity.StudioEventEmitter insideMusicEmitter; // �cie�ka do event emittera na scenie
    public FMODUnity.StudioEventEmitter outsideMusicEmitter;
    bool pressed = false;
    ...
    {
        if (insideMusicEmitter.IsPlaying())
        {
            insideMusicEmitter.Stop();
            outsideMusicEmitter.Play();
        }
        else if (outsideMusicEmitter.IsPlaying())
        {
            outsideMusicEmitter.Stop();
            insideMusicEmitter.Play();
        }
    }
